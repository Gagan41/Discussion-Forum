  ...
  return (
    ...
    >
      ...
      >
       ...
       <h2 className="text-black dark:text-white">HOME</h2>
      </li>
      <li
      ...
      >
        ...
        <h2 className="text-black dark:text-white">EXPLORE TOPICS</h2>
      </li>
      <li
        onClick={() => {
          navigate("/chat");
      ...
      >
        ...
        <h2 className="text-black dark:text-white">CHAT</h2>
      </li>
      <li
      ...
      >
        ...
        <h2 className="text-black dark:text-white">MY QNA</h2>
      </li>
      ...
      >
        ...
        <h2 className="text-black dark:text-white">Ask a Question</h2>
      </li>
    </div>
  );
};
